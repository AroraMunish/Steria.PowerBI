...
lab:
    ...
    module: 'Module 09 - Perform Advanced Analytics'
---
...
4. In the **Open** window, navigate to the **07-design-report-in-power-bi-desktop-enhanced\Solution** folder.
...
7. In the **Save As** window, navigate to the **C:\PowerBI\MySolution** folder.
...
7. To add a forecast, beneath the **Visualizations** pane, select the **Analytics** pane.
	...
	![Picture 20](Linked_image_Files/10-perform-data-analysis-in-power-bi-desktop_image26.1.png)
...
9. Scroll down and **Switch on** Forecast.
