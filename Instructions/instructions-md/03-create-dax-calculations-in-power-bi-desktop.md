...
lab:
    ...
    module: 'Module 3 - Create Model Calculations using DAX in Power BI'
---
...
1. In the **Open** window, 
   ...
   **a. For connecting to Local Database**
   	...
   	Navigate to **C:\PowerBI\Labs\03-create-dax-calculations-in-power-bi-desktop\Starter** folder.

	**b. For connecting to Azure Database**

     Navigate to **C:\PowerBI\LabsWithDBInAzure\03-create-dax-calculations-in-power-bi-desktop\Starter** folder.
...
1. In the **Save As** window, navigate to the **C:\PowerBI\MySolution** folder.

1. Click **Save** and save it as **03.Sales Analysis.pbix**..
...
2. In the formula bar (which opens directly beneath the ribbon when creating or editing calculations), type **Salesperson =**, press **Shift+Enter**, type **'Salesperson (Performance)'**, and then press **Enter**.
	...
	*For your convenience, all DAX definitions in this lab can be copied from the snippets file, located in **C:\PowerBI\Labs\03-create-dax-calculations-in-power-bi-desktop\Assets\Snippets.txt**.*
