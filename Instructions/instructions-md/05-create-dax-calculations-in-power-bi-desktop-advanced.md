...
1. In the **Open** window, navigate to the **C:\PowerBI\Labs\05-create-dax-calculations-in-power-bi-desktop-advanced\Starter** folder.
...
1. Add a measure to the **Sales** table, based on the following expression:
    ...
    *For your convenience, all DAX definitions in this lab can be copied from the **C:\PowerBI\Labs\05-create-dax-calculations-in-power-bi-desktop-advanced\Assets\Snippets.txt** file.*
