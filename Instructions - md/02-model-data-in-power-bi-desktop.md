...
1. In the **Open** window, navigate to the **D:\PowerBI\Labs\02-configure-data-model-in-power-bi-desktop\Starter** folder.
...
1. In the **Save As** window, navigate to the **D:\PowerBI\MySolution** folder,  , and save the file as **02.Sales Analysis.pbix** as Click **Save**.
