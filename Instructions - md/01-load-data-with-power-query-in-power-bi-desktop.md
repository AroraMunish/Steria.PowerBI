...
1. In the **Open** window, navigate to the **D:\PowerBI\Labs\01-load-data-with-power-query-in-power-bi-desktop\Starter** folder.
...
1. In the **Save As** window, navigate to the **D:\PowerBI\Labs\MySolution** folder, and save the file as **01.Sales Analysis.pbix** as Click **Save**.
...
8. For your convenience, you can copy the expression from the **D:\PowerBI\Labs\01-load-data-with-power-query-in-power-bi-desktop\Assets\Snippets.txt** file.
