...
1. In the **Open** window, navigate to the **D:\PowerBI\Labs\05-create-dax-calculations-in-power-bi-desktop-advanced\Starter** folder.
...
1. In the **Save As** window, navigate to the **D:\PowerBI\MySolution** folder, and save the file as **05.Sales Analysis.pbix** as Click **Save**.
...
1. Add a measure to the **Sales** table, based on the following expression:
    ...
    *For your convenience, all DAX definitions in this lab can be copied from the **D:\PowerBI\Labs\05-create-dax-calculations-in-power-bi-desktop-advanced\Assets\Snippets.txt** file.*
