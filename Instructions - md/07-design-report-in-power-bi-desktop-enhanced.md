...
8. In the **Open** window, navigate to the **D:\PowerBI\Labs\07-design-report-in-power-bi-desktop-enhanced\Starter** folder.
...
15. In the **Save As** window, navigate to the **D:\PowerBI\MySolution** folder, and save the file as **07.Sales Analysis.pbix** as Click **Save**.
